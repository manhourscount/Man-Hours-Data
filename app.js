...
function exportMetrics() {
 ...
 .title-header { background-color: #0f766e; color: #ffffff; font-size: 14pt; font-weight: bold; text-align: center; padding: 12px; height: 62px; border-right: 2px solid #e2e8f0; border-bottom: 2px solid #115e59; }
 ...
 .section-header { background-color: #115e59; color: #ffffff; font-weight: bold; font-size: 11pt; text-align: center; padding: 8px; height: 42px; border-right: 1px solid #e2e8f0;}
 .label-col { background-color: #f8fafc; color: #334155; width: 447px; border-left: 1px solid #e2e8f0; border-bottom: 1px solid #e2e8f0; border-right: 2px solid #e2e8f0; }
